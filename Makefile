...
# -----------------------------------------------------------
spark.root=/home/utkarsh/neu/MR/spark/spark-2.4.0-bin-without-hadoop
hadoop.root=/home/utkarsh/neu/MR/hadoop
app.name=Word Count
jar.name=spark-demo.jar
maven.jar.name=spark-demo-1.0.jar
job.name=com.mr.spark.housingprice.housingPrediction
local.master=local[4]
local.input=input
local.output=output
# Pseudo-Cluster Execution
hdfs.user.name=utkarsh
hdfs.input=input
hdfs.output=output
# AWS EMR Execution
