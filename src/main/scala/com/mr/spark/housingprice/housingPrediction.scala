...
object housingPrediction {
  ...
  def main(args: Array[String]) {
    ...
    (1), parseDouble(p(2)), parseDouble(p(3)), p(4), p(5), p(6), p(7), p(8), p(9),
      p(10), p(11), p(12), p(13), p(14), p(15), p(16).toInt, p(17).toInt, p
      (18).toInt, p(19).toInt,
      p(20), p(21), p(22), p(23), p(24), p(25), p(26), p(27), p(28), p(29),
      p(30), p(31), p(32),parseDouble(p(33)), p(34), parseDouble(p(35)), parseDouble(p(36)), parseDouble(p(37)), p(38), p(39),
      p(40), p(41), parseDouble(p(42)), parseDouble(p(43)), parseDouble(p(44)), parseDouble(p(45)), parseInt(p(46)), p(47).toInt, p(48).toInt, p(49).toInt,
    ...
    (1), parseDouble(p(2)), p(3).toDouble, p(4), p(5), p(6), p(7), p(8), p(9),
      ...
      (18).toInt, p(19).toInt,
      p(20), p(21), p(22), p(23), p(24), p(25), p(26), p(27), p(28), p(29),
      p(30), p(31), p(32), parseDouble(p(33)), p(35),parseDouble(p(36)),parseDouble(p(37)),
      parseDouble(p(37)), p(38), p(39),
      p(40), p(41), p(42).toDouble, p(43).toDouble, p(44).toDouble, p(45)
        .toDouble,  parseInt(p(46)),  parseInt(p(47)),  parseInt(p(48)),  parseInt(p(49)),
      p(50).toInt, p(51).toInt, p(52), p(53).toInt, p(54), p(55).toInt, p(56)
      , p(57), parseInt(p(58)), p(59),
      parseInt(p(60)),parseDouble(p(61)), p(62), p(63), p(64), parseDouble(p(65)), p(66)
        .toDouble, p(67).toDouble, p(68).toDouble, p(69).toDouble,
      p(70).toDouble, p(71), p(72), p(73), p(74), p(75).toInt, p(76).toInt, p
